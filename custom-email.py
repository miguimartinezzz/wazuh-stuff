...
def generate_msg(alert):
    ...
    attack = alert['data']['attack']
    devid = alert['data']['devid']
    devname = alert['data']['devname']
    srcintf = alert['data']['srcintf']
    dstintf= alert ['data']['dstintf']
    log = alert['full_log']
    subject = '[Wazuh Alert]: Fortigate IPS:[ {0} ]'.format(attack)
    ...
    <tr class="tabla-detail">
    <td><p class="Normal"><strong>Srcintf</strong></p></td>
    <td class="tabla-manual celda-detail"><p><strong>{}</strong></p></td>
    </tr>
    <tr class="tabla-detail">
    <td><p class="Normal"><strong>Srcip</strong></p></td>
    <td class="tabla-manual celda-detail"><p><strong>{}</strong></p></td>
    </tr>
    <tr class="tabla-detail">
    <td><p class="Normal"><strong>Srcport</strong></p></td>
    <td class="tabla-manual celda-detail"><p><strong>{}</strong></p></td>
    </tr>
    <tr class="tabla-detail">
    <td><p class="Normal"><strong>Dstintf</strong></p></td>
    <td class="tabla-manual celda-detail"><p><strong>{}</strong></p></td>
    </tr>
    <tr class="tabla-detail">
    <td><p class="Normal"><strong>Dstip</strong></p></td>
    <td class="tabla-manual celda-detail"><p><strong>{}</strong></p></td>
    </tr>
    <tr class="tabla-detail">
    <td><p class="Normal"><strong>Dstport</strong></p></td>
    <td class="tabla-manual celda-detail"><p><strong>{}</strong></p></td>
    </tr>
    <tr class="tabla-detail">
    <td><p class="Normal"><strong>Attack</strong></p></td>
    <td class="tabla-manual celda-detail"><p><strong>{}</strong></p></td>
    </tr>
    <tr class="tabla-detail">
    ...
    """.format(devname,srcintf, srcip, srcport, dstintf, dstip, dstport, attack, timestamp, location, log)
